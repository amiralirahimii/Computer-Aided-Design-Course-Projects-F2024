...
# Pleas add other module here	
	...
	vlog 	+acc -incr -source  +define+SIM 	$hdl_path/mux16tto1.v
...
#====================================== run =====================================
	...
	run $run_time 
	run -all
	mem save -outfile ./file/output.mem -addressradix decimal -dataradix hex -wordsperline 4 /testBench/mainProccess/myDataPath/myMem/mem